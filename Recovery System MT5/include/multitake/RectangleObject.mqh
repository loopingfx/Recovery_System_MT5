...
//+------------------------------------------------------------------+
bool CRectangleObject::RectangleCreate(const long            chart_ID=0,// chart's ID
...
//+------------------------------------------------------------------+
bool CRectangleObject::RectanglePointChange(const long   chart_ID=0,// chart's ID
                                            const string name="Rectangle", // rectangle name
...
//+------------------------------------------------------------------+
bool CRectangleObject::RectangleDelete(const long   chart_ID=0,// chart's ID
                                       const string name="Rectangle") // rectangle name
  {
//--- reset the error value
   ResetLastError();
...
//+------------------------------------------------------------------+
void CRectangleObject::ChangeRectangleEmptyPoints(datetime &time1,double &price1,
                                                  datetime &time2,double &price2)
  {
